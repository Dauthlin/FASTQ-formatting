...
def test_file_and_nucleotide():
    ...
    program_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), "FASTQ_Zipped_Counting.py")
...
def test_file_and_nucleotide_zipped():
    # gets the path of the program to test
    program_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), "FASTQ_Zipped_Counting.py")
    # gets the path of the zipped data
    data_path = os.path.join(os.path.dirname(__file__), "fake_test_file.fastq.gz")
    # combines them into a single command
    command = str("python " + program_path + " -f " + data_path + " -n true")
    # runs the command
    result = (run(cmd=command)).decode('ascii').strip()
...
def test_file_and_series_and_nucleotide_zipped():
    # gets the path of the program to test
    program_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), "FASTQ_Zipped_Counting.py")
    # gets the path of the zipped data
    data_path = os.path.join(os.path.dirname(__file__), "fake_test_file.fastq.gz")
